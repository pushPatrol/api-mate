...
(function() {
  ...
  $(function() {
    ...
    return $(".events-template").on("click", function(e) {
      ...
      return this.selectTemplateTimeout = setTimeout((function(_this) {
        return function() {
  ...
  window.RedisEvents = RedisEvents = (function() {
    function RedisEvents() {
      this.onMessageError = bind(this.onMessageError, this);
    ...
    RedisEvents.prototype.bind = function() {
      this.bindSearch();
      $("[data-events-out-submit]").on("click", (function(_this) {
        return function(e) {
          var channel, content;
      ...
      $("[data-events-server-connect]").on("click", (function(_this) {
        return function(e) {
          var url;
      ...
      return $("[data-events-out-pretty]").on("click", (function(_this) {
        return function(e) {
    ...
    RedisEvents.prototype.selectTemplate = function(text) {
      ...
      return this.selectTemplateTimeout2 = setTimeout((function(_this) {
        return function() {
