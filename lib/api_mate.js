...
(function() {
  ...
  window.ApiMate = ApiMate = (function() {
    ...
    ApiMate.prototype.start = function() {
      var _this = this;
      return this.loadServers(function() {
    ...
    ApiMate.prototype.loadServers = function(callback) {
      var _this = this;
      return $.getJSON('servers.json').done(function(servers) {
        var $option, $select, server, _i, _len;
    ...
    ApiMate.prototype._startAfterServers = function() {
      ...
      $("[data-api-mate-server='url']").on("change", function() {
